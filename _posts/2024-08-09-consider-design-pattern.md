...
웹뷰 환경에서는 기존의 **Presentational/Container** 패턴이 항상 최선의 선택이 아니었습니다.

웹뷰는 앱과 달리 다양한 사용자 상호작용을 최소화하고, 특정 기능을 집중적으로 제공하는 UX를 목표로 하므로, 컴포넌트에 비즈니스 로직을 포함하는 것이 불가피했습니다.

이로 인해 **Compound Component** 패턴을 도입하게 되었습니다.
